...
-- 	EQUIPMENT_ID	INT		NOT NULL,
-- 	SPORT_ID	INT		NOT NULL,
-- 	EQUIPMENT_CHECKOUT TIMESTAMP 	NOT NULL,
...
CREATE TABLE 	F21_S001_8_MEMBER_ACTIVITY (MEMBER_ID INT , EQUIPMENT_ID INT, SPORT_ID INT,EQUIPMENT_CHECKIN TIMESTAMP NOT NULL, EQUIPMENT_CHECKOUT TIMESTAMP NOT NULL, PRIMARY KEY(MEMBER_ID), 
